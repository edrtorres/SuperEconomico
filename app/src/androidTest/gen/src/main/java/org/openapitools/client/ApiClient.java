...
public class ApiClient {
    ...
    private String basePath = "https://mvrlcbcydpubhovvrmvf.supabase.co";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://mvrlcbcydpubhovvrmvf.supabase.co",
      "Supabase Producción",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://mvrlcbcydpubhovvrmvf.supabase.co
